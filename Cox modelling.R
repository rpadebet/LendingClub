...
loan_linear_mdl_2012H1_Cur<-lm(DEFAULT ~ int_rate + UNEMP.RT.BEGIN_DT+MONTH.AGE.BEGIN,
                               data = loan_sample_all_model_2012H1)
loan_linear_mdl_2012H1_Iss<-lm(DEFAULT ~ int_rate + UNEMP.RT_ISS+MONTH.AGE.BEGIN,
                               data = loan_sample_all_model_2012H1)
loan_linear_mdl_2012H1_Both<-lm(DEFAULT ~ int_rate + UNEMP.RT_ISS+ UNEMP.RT.BEGIN_DT+MONTH.AGE.BEGIN,
                                data = loan_sample_all_model_2012H1)
...
loan_linear_mdl_2014Q4_2015_Cur<-lm(DEFAULT ~ int_rate + UNEMP.RT.BEGIN_DT+MONTH.AGE.BEGIN,
                                    data = loan_sample_all_model_2014Q4_2015)
loan_linear_mdl_2014Q4_2015_Iss<-lm(DEFAULT ~ int_rate + UNEMP.RT_ISS+MONTH.AGE.BEGIN,
                                    data = loan_sample_all_model_2014Q4_2015)
loan_linear_mdl_2014Q4_2015_Both<-lm(DEFAULT ~ int_rate + UNEMP.RT_ISS+ UNEMP.RT.BEGIN_DT+MONTH.AGE.BEGIN,
                                     data = loan_sample_all_model_2014Q4_2015)
