...
Sample Data is for loans issues from 2012 through to 215 onwards in the state of California with a 36 month term. A random sample of 1000 such loans is chosen for the analysis
```{r}
...
#### Fit a Linear Model
```{r}
loan_linear_mdl<-glm(DEFAULT ~ int_rate + UNEMP.RT.BEGIN_DT+MONTH.AGE.BEGIN,
